...
Image được build từ `Dockerfile` chứa luôn Mosquitto và InfluxDB. Khi khởi
động, script entrypoint sẽ chạy InfluxDB, chờ sẵn sàng, tạo database và user
theo biến môi trường, sau đó chạy Mosquitto và ứng dụng Python. Bạn chỉ cần
một container:
